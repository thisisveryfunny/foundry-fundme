...
contract FundMeTest is Test {
    ...
    function setUp() external {
        ...
        vm.deal(USER, BALANCE); // add balance to the fake user.
    }
    ...
    function testPriceFeedVersionIsAccurate() public view {
        uint256 version = fundMe.getVersion(); // need to add forked url --fork-url $RPC_URL
        assertEq(version, 4);
    }

    function testMinUsdFailNotEnoughEth() public {
        vm.expectRevert();
        fundMe.fund();
    }
